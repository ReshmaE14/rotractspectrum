					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e3.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e3.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e4.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e4.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e5.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e5.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e6.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e6.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e7.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e7.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e8.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e8.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e9.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e9.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
					...
					<div class="col">
						<div class="gallery-image">
							<div class="hover-overlay">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/easter/e10.jpg" alt="gallery-image">
								<div class="item-overlay"></div>

								<!-- Image Zoom -->
								<div class="image-data">
									<div class="gallery-link ico-40 color--white">
										<a class="image-link" href="images/easter/e10.jpg">
											<span class="flaticon-visibility"></span>
										</a>
									</div>
								</div>
